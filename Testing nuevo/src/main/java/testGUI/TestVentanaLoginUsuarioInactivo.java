...
public class TestVentanaLoginUsuarioInactivo
{
	Robot robot;
	...
	public void testLogin()
    {
        ...
        TestUtils.tipeaTexto("E", robot);
        TestUtils.clickComponent(contrasena, robot);
        TestUtils.tipeaTexto("Imanol1", robot);
        TestUtils.clickComponent(aceptarLog, robot);
        //verifico los resultados
        Assert.assertTrue("Un usuario inactivo no puede ingresar al sistema.", controladorLogin.getVista().isVisible());
        Assert.assertEquals("Usuario inactivo", lejbel.getText());
    }
}