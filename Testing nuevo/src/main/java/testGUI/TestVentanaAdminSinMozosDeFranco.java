...
public class TestVentanaAdminSinMozosDeFranco
{
	Robot robot;
	...
	public void testArrancarDia()
    {
        ...
        Assert.assertFalse("Deber\u00eda estar deshabilitado el bot\u00f3n porque no hay mozos de Franco.", facturacion.isEnabled());
