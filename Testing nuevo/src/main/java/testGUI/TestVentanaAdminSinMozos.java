...
public class TestVentanaAdminSinMozos
{
	Robot robot;
	...
	public void testArrancarDia()
    {
        ...
        Assert.assertFalse("Deber\u00eda estar deshabilitado el bot\u00f3n porque no hay mozos.", facturacion.isEnabled());
        Assert.assertEquals("Se necesita al menos 1 mozo en estado activo para iniciar el dia", lblExcepcionInicioDia.getText());
    }
}
